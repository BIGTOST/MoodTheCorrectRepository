...
public class SUICID : MonoBehaviour
{
    // Referência ao Animator do objeto
    private Animator animator;

    // Referências aos pontos 1 e B
    ...
    void Update()
    {
        if (PONTO1 == null || pontoB == null)
        {
            Debug.LogError("Ponto1 and PontoB need to be assigned in the inspector.");
            return;
        }
