...
public class DEPRESS : MonoBehaviour
{
    // Referência ao Animator do objeto
    private Animator animator;

    // Referências aos pontos 2 e B
    ...
    void Start()
    {
        ...
        {
            Debug.LogError("PontoB is not assigned in the inspector.");
        }
    }
    ...
    void Update()
    {
        if (ponto2 == null || pontoB == null)
        {
            Debug.LogError("Ponto2 and PontoB need to be assigned in the inspector.");
            return;
        }
